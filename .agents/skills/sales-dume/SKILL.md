---
name: sales-dume
description: "Dume.ai platform help — chat-first AI executive assistant connecting Gmail, Calendar, Slack, Jira, Notion, GitHub and 50+ tools for email triage, no-code workflow automation, custom AI agents, and daily task management. Use when email triage or smart draft responses aren't working right, a no-code workflow isn't triggering, setting up webhook-based automations on the PRO plan, a tool integration keeps disconnecting or failing to sync, connecting an external MCP server for real-time data, building custom AI agents for specialized tasks, WhatsApp messages not sending or receiving, the morning briefing pulling the wrong calendar or email data, evaluating Dume.ai vs alfred_ vs Lindy vs Saner.AI as an AI executive assistant, or choosing the right Dume plan. Do NOT use for AI calendar auto-scheduling with project management (use /sales-motion), choosing a dedicated AI meeting note-taker (use /sales-note-taker), or general tool integration architecture (use /sales-integration)."
