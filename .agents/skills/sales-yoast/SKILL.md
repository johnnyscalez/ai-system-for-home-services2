...
- `/sales-semrush` — Semrush SEO platform (keyword research, site audits, rank tracking, backlink analysis). Install:
  `npx skills add sales-skills/sales --skill sales-semrush -a claude-code`
- `/sales-ai-visibility` — AI visibility monitoring (track what ChatGPT, Perplexity, Gemini say about your brand). Install:
