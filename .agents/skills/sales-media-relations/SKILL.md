...
description: "Media relations and PR outreach strategy across platforms — journalist databases, media list building, pitch writing, outreach sequences, press coverage tracking, and earned media measurement. Covers platform comparison (Meltwater, Cision, Muck Rack, Prowly, Agility PR, BuzzStream), journalist research, media list segmentation and tiering, pitch writing (subject lines, personalization, angles, timing), outreach sequences (initial pitch, follow-ups, exclusives, embargoes), coverage tracking, and PR measurement (earned media value, share of voice, sentiment). Use when journalists aren't responding to pitches, you're unsure which reporters cover your beat, press outreach isn't landing coverage, you can't measure PR impact, or you don't know which media database to pick. Do NOT use for platform-specific config (use /sales-meltwater), influencer outreach (use /sales-influencer-marketing), cold sales email outreach (use /sales-outreach or /sales-cadence), or social listening (use /sales-social-listening)."
