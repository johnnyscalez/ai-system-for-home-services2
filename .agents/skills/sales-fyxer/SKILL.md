...
- `/sales-hi-ai` — hi ai platform help (AI customer service email reply generator, multi-model, Google Sheets data). Install:
  `npx skills add sales-skills/sales --skill sales-hi-ai -a claude-code`
