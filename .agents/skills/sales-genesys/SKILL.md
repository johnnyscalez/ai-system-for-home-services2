---
name: sales-genesys
description: "Genesys Cloud CX platform help — enterprise CCaaS with AI experience orchestration, omnichannel ACD routing (voice + digital), Architect IVR/flow builder, workforce management (WFM), quality management, predictive routing, agent assist, outbound dialer, Interaction Analytics, AppFoundry marketplace, REST Platform API with OAuth 2.0 and regional endpoints, deep Salesforce integration (CX Cloud + Service Cloud Voice), 4 tiers CX1 $75 / CX2 $115 / CX3 $155 / CX4 $240 per user/mo plus telephony minutes (AI is CX4-only, WFM needs CX3). Use when setting up Genesys routing or Architect flows, WFM forecasting not matching actual volume, quality evaluations not triggering coaching, dropped calls or audio quality, comparing pricing tiers, integrating with Salesforce or ServiceNow, reporting hard to navigate, MFA management, Genesys API integration, or evaluating enterprise CCaaS platforms. Do NOT use for a general coaching program (use /sales-coaching) or comparing CCaaS platforms (use /sales-ccaas-selection)."
