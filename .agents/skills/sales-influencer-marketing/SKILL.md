...
description: "Influencer marketing strategy across platforms — creator discovery, audience vetting, campaign tracking, outreach, gifting, and affiliate programs. Covers platform comparison (Modash, influData, Influencity, HypeAuditor, trendHERO, and the full long tail in references), discovery workflow, vetting (fake followers, engagement authenticity, demographics), campaign tracking (EMV, ROAS, CPM, attribution), outreach, gifting, and creator payments. Use when unsure which influencer platform to pick, can't find the right creators for your niche, worried about fake followers or inflated metrics, campaigns aren't being tracked, creators aren't responding, or influencer spend isn't showing ROI. Do NOT use for platform-specific config (use /sales-modash, /sales-infludata, /sales-influencity, /sales-hypeauditor, etc.), TikTok marketing (use /sales-tiktok-marketing), gaming influencer marketing (use /sales-gaming-marketing), ad campaigns (use /sales-retargeting), or email marketing (use /sales-email-marketing)."
...
- Open Influence setup, config, or agency services → `/sales-openinfluence`
- Viral Nation setup, CreatorOS, Secure, or agency services → `/sales-viralnation`
- trendHERO setup, config, or features → `/sales-trendhero`
...
- HypeAuditor setup, config, or features → `/sales-hypeauditor`
- Aspire setup, config, or features → `/sales-aspire`
- Influencer Hero setup, config, or features → `/sales-influencer-hero`
- Later Influence setup, config, or features → `/sales-later`
- Sprout Social influencer features → `/sales-sproutsocial`
- Upfluence setup, Live Capture, Jaice AI, affiliate/promo codes → `/sales-upfluence`
- GRIN setup, config, or features → `/sales-grin`
- PlutoBa vetting, PlutoBa Score, brand safety, rate benchmarks → `/sales-plutoba`
- FansRevenue setup, creator monetization, or brand partnerships → `/sales-fansrevenue`
- Passionfroot setup, Zest AI agent, creator storefronts, FrootWallet → `/sales-passionfroot`
...
**Read `references/platform-guide.md`** for detailed platform comparison tables, discovery workflows, vetting frameworks, outreach best practices, rate benchmarks, gifting programs, campaign tracking, and affiliate program guidance.
...
- `/sales-hypeauditor` — HypeAuditor platform help — AI analytics, fraud detection (53 patterns), Discovery (223.6M+ profiles), Campaign Management, API
- `/sales-aspire` — Aspire platform help — word-of-mouth commerce, product seeding, affiliate tracking, UGC, paid social
- `/sales-influencer-hero` — Influencer Hero platform help — all-in-one influencer marketing, 200M+ profiles, automated outreach, CRM, affiliate tracking, product gifting, API
- `/sales-instajet` — InstaJet.io platform help — Instagram Stories influencer marketplace, 10K+ vetted creators, escrow payments, managed service
- `/sales-openinfluence` — Open Influence platform help — AI-powered influencer agency + SaaS, image recognition search, paid media amplification, Studio OI
- `/sales-viralnation` — Viral Nation platform help — enterprise influencer agency + SaaS, CreatorOS campaign management, Secure AI brand safety, talent representation
- `/sales-upfluence` — Upfluence platform help — influencer and affiliate marketing for ecommerce, Live Capture, Jaice AI, commission-free affiliate tracking
- `/sales-grin` — GRIN platform help — creator management, discovery, gifting, affiliate hub, social listening, Gia AI agent
- `/sales-trendhero` — trendHERO platform help — Instagram influencer analytics, 95M+ profiles, AQS fake follower detection, Ads Database, REST API
...
- `/sales-passionfroot` — Passionfroot platform help — AI-powered B2B creator marketing, Zest AI agent, storefronts, FrootWallet, cross-platform analytics
