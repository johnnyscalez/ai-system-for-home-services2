...
| Collaborative inbox with co-drafting | Missive | Internal threads, co-write emails, multi-channel, $14-36/user |
| Gmail + AI + Kanban workflow | Gmelius | Meli AI assistant, Kanban boards, powerful automations |
...
- `/sales-missive` — Missive platform help (collaborative team inbox, internal threads, co-drafting, API). Install:
...
**Skill does**: Audits their usage pattern — if primarily ticketing + chat + knowledge base, compares Freshdesk Enterprise ($79/agent), Help Scout Plus ($44/user), and Front Professional ($65/seat). Calculates annual savings. Flags migration complexity and suggests a phased pilot.
