...
- `/sales-mailman` — Mailman Gmail plugin (email batching, Do Not Disturb, unknown sender blocking, $8-10/mo). Install:
  `npx skills add sales-skills/sales --skill sales-mailman -a claude-code`
