...
- **/sales-moosend** — Moosend platform help (budget ESP, automations, ecommerce AI recommendations, landing pages, API)
- **/sales-sender** — Sender platform help (budget ESP, generous free tier, automation, SMS, transactional email, REST API)
- **/sales-constantcontact** — Constant Contact platform help (event management, campaigns, automation, SMS, V3 REST API)
