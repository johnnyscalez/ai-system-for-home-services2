...
### Building prospect lists in Swan

- **Lookalike prospecting**: Swan's Doggo agent analyzes closed-won deals to find similar companies by industry, size, and technology stack. Automatically identifies buying committees and enriches contacts.
- **Website visitor lists**: Gatto agent deanonymizes website visitors, qualifies against ICP, and builds prospect lists from high-intent visitors.
- **Natural language list building**: Describe your ideal prospect in plain English — Swan finds, researches, qualifies, and enriches matching companies and contacts.
- **Credit cost**: Each prospect discovered and enriched costs ~3-5 credits (research + qualification + enrichment). 4,000 credits/mo can build ~800-1,300 enriched prospects.
- **Best for**: Teams wanting autonomous list building tied to intent signals or deal patterns rather than manual database searching. For bulk database access, Apollo or ZoomInfo offer more direct search.
