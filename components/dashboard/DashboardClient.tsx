...
type Props = {
  ...
  stats: {
    totalLeads: number; newLeads: number; contacted: number; qualified: number
    booked: number; cold: number; needsAttention: number; followUpsSent: number
    bookingRate: number; revenueProjected: number; avgJobValue: number
  }
  recentLeads: {
...
// ── Main ───────────────────────────────────────────────────────────────────────
export function DashboardClient({ greeting, firstName, companyName, stats, recentLeads, upcomingApts }: Props) {
  return (
    <div className="relative min-h-full bg-[#FAFAF8] overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 py-8 space-y-8">
          ...
          {stats.needsAttention > 0 && (
            ...
            >
              ...
              >
                ...
                {stats.needsAttention} lead{stats.needsAttention !== 1 ? "s" : ""} need attention
        ...
        {stats.booked > 0 && stats.avgJobValue > 0 && (
          ...
          >
            ...
            <div className="relative flex items-center justify-between">
              <div>
                <p className="text-purple-200 text-sm font-medium tracking-wide">Projected revenue this month</p>
                <motion.p
                ...
                <p className="text-purple-200 text-sm mt-2">
                  {stats.booked} appointment{stats.booked !== 1 ? "s" : ""} booked ×{" "}
        ...
        {/* Stats grid */}
        <div>
          {/* Stripe-style gradient band behind stats */}
